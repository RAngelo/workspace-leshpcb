...
cprequire_test(["inline:com-chilipeppr-workspace-leshpcb"], function(ws) {
    ...
    $('title').html("IFPB - LESH PCB STATION");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-leshpcb", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-leshpcb", // Make the id the same as the cpdefine id
        name: "IFPB - LESH PCB STATION", // The descriptive name of your widget.
        desc: `THE MOST BAMBAMBAM STATION EVER SEEN.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a leshpcb
