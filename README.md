# com-chilipeppr-workspace-leshpcb
THE MOST BAMBAMBAM STATION EVER SEEN.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr IFPB - LESH PCB STATION
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-leshpcb |
| Name                  | IFPB - LESH PCB STATION |
| Description           | THE MOST BAMBAMBAM STATION EVER SEEN. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/RAngelo/workspace-leshpcb/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/rafaelangelovieira/pcblesh |
| Github URL            | http://github.com/RAngelo/workspace-leshpcb |
| Test URL              | https://preview.c9users.io/rafaelangelovieira/pcblesh/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/RAngelo/workspace-leshpcb/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-leshpcb"], // the id you gave your workspace
      function(myWorkspaceLeshpcb) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("IFPB - LESH PCB STATION just got loaded.", myWorkspaceLeshpcb);
        myWorkspaceLeshpcb.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-leshpcb"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"IFPB - LESH PCB STATION"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"THE MOST BAMBAMBAM STATION EVER SEEN."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/RAngelo/workspace-leshpcb/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/rafaelangelovieira/pcblesh"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/RAngelo/workspace-leshpcb"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://pcblesh-rafaelangelovieira.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
